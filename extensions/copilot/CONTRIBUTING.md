...
- (Windows) Visual Studio Build Tools >=2026（亦兼容 2022 / 2019）- for building with node-gyp [see node-gyp docs](https://github.com/nodejs/node-gyp?tab=readme-ov-file#on-windows)

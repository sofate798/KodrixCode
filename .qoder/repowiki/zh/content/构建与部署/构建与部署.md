...
- [.github/workflows/build.yml:1-125](file://.github/workflows/build.yml#L1-L125)
...
- [build/gulpfile.ts:26-47](file://build/gulpfile.ts#L26-L47)
- [.github/workflows/build.yml:98-125](file://.github/workflows/build.yml#L98-L125)
- [.github/workflows/pr-check.yml:59-80](file://.github/workflows/pr-check.yml#L59-L80)
...
**图示来源**
- [.github/workflows/build.yml:13-53](file://.github/workflows/build.yml#L13-L53)
- [.github/workflows/build.yml:98-125](file://.github/workflows/build.yml#L98-L125)
...
**章节来源**
- [.github/workflows/build.yml:1-125](file://.github/workflows/build.yml#L1-L125)
- [.github/workflows/pr-check.yml:1-80](file://.github/workflows/pr-check.yml#L1-L80)
...
## 结论
Kodrix 的构建与部署体系以 Gulp 为核心编排，结合 esbuild 实现高效开发体验，并通过现代化的统一 CI 流水线完成多端打包与发布。新的统一三平台构建工作流、标准化的制品命名约定、严格的 Node.js 版本管理和增强的安全扫描功能，进一步提升了构建效率、可维护性和安全性。遵循本文档的流程与最佳实践，可稳定地实现从代码到产品的端到端交付。

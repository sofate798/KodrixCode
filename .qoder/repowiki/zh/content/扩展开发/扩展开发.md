...
- 具体扩展如 kodrix-agent-os、kodrix-local 通过各自的 package.json 声明入口、激活事件、贡献点（命令、视图、菜单、设置渲染器、聊天参与者等）。
...
E["src/vs/platform/extensions/common/extensions.ts<br/>扩展清单与类型定义"] --> C
E --> D
```
...
**章节来源**
- [package.json:12-100](file://package.json#L12-L100)
- [extensions/kodrix-agent-os/package.json:275-278](file://extensions/kodrix-agent-os/package.json#L275-L278)

...
/**
 * Kodrix Code logo "fish" used by the Agents window aquarium. Each fish is a small
...
/** The three Kodrix Code release channel colors used as fish "species". */
 ...
 * a single `<symbol>` containing the Kodrix Code logo path. All fish reference
 ...
 *   - Kodrix Code logo body, sliced into N vertical strips that each oscillate in
...
function buildFishSvg(targetDocument: Document): SVGSVGElement {
	...
	// viewBox 0..96 matches the original Kodrix Code icon.

...
export class WorkspacePicker extends Disposable {
	...
	/** Cached Kodrix Code recent folder URIs, resolved lazily. */
	...
	constructor(
		...
		// Load Kodrix Code recent folders eagerly and refresh on changes
	 ...
	 * without source grouping. Own recents come first, followed by Kodrix Code
	 * recent folders.
	 */
	protected _buildItems(): IActionListItem<IWorkspacePickerItem>[] {
		...
		// Merge Kodrix Code recent folders (resolved through providers, deduplicated)
	...
	/**
	 * Returns Kodrix Code recent folders resolved through registered session

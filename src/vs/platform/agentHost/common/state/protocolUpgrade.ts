 ...
 * by the Kodrix Code CLI, asks the CLI to check for a server upgrade and
 ...
 * data payload. Servers that are spawned by the Kodrix Code CLI populate this
 ...
 * extension used by Kodrix Code-hosted agent hosts.
 *

...
configurationRegistry.registerConfiguration({
	...
	properties: {
		...
		'chat.editor.defaultProvider': {
			...
			enumDescriptions: [
				nls.localize('chat.editor.defaultProvider.local', "Use the built-in Kodrix Code local chat harness"),
		...
		'chat.editor.localAgent.enabled': {
			type: 'boolean',
			description: nls.localize('chat.editor.localAgent.enabled', "When enabled, shows the Kodrix Code local chat harness in the chat picker."),
			default: true,
			tags: ['experimental'],
			experiment: { mode: 'startup' },
		},

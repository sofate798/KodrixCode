...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit Kodrix Code's "shell environment" that may
	 ...
	 * a terminal used to drive some Kodrix Code feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to Kodrix Code and extensions
	 */
...
export const enum ShellIntegrationStatus {
	...
	FinalTerm,
	/** Kodrix Code shell integration sequences have been encountered. Supercedes FinalTerm. */
	VSCode
}

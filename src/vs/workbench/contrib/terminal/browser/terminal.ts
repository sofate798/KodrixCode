 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in Kodrix Code UI).
 */
 ...
 * to represent terminals that appear in other parts of the Kodrix Code UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their Kodrix Code OSC `SetMarker`
...
export interface IDetachedXtermTerminal extends IXtermTerminal {
	...
	/**
	 * Updates the xterm log level to match the given Kodrix Code log level.
	 */
	updateLogLevel(): void;

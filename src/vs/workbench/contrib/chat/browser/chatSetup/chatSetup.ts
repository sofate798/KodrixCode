...
/**
 * Builds a redirect URL that GitHub will use to return the user to Kodrix Code
 ...
 * @param urlProtocol The Kodrix Code URL protocol scheme (e.g. `vscode`, `vscode-insiders`, `code-oss`).

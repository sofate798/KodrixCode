...
/**
 * Allows webviews to monitor when an element in the Kodrix Code editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. Kodrix Code needs to see this

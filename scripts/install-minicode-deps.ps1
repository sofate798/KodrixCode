# Minicode / VS Code 依赖安装脚本（Windows PowerShell）
# 用法: .\scripts\install-minicode-deps.ps1
...
$subdirs = @(
	'build',
	'extensions/minicode-local',
	'extensions/minicode-skills',
	'extensions/minicode-solo',
	'extensions/minicode-agent-os'
)
...
Write-Host "  npm run gulp -- compile-extension:minicode-agent-os compile-extension:minicode-solo compile-extension:minicode-local compile-extension:minicode-skills"
Write-Host ""
if (-not $Full) {
